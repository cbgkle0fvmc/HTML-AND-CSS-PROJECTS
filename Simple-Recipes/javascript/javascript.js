...
document.getElementById('contactForm').addEventListener('submit',
    function (event) {
        //Overrides the default browser refresh when a submit
        //button is pressed
        ...
        //for an email address such as the @ and the . and the text
        ...
        if(!firstName || !lastName || !phone || !message) {
            ...
            valMsg.innerHTML = '<p style="color:red;"> Please fill out all emply fields</p>'
        } else if (!emailPattern.test(email)) {
            //Checks if there is a valid email
            valMsg.innerHTML = '<p style="color: red;">Please enter a valid email.</p>'
        } else {
            //If all fields are filled out properly display a thank you message.
        ...
        //Displays ehat the user wrote in the console
